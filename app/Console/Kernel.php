...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('csvImport:cron')->cron('0 15 * * *')->withoutOverlapping();
        $schedule->command('download:cron')->cron('0 18 * * *')->withoutOverlapping();
        $schedule->command('account:cron')->cron('0 20 * * *')->withoutOverlapping();
        $schedule->command('vendor:cron')->cron('0 20 * * *')->withoutOverlapping();
