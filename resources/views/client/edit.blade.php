                        ...
                        <form action="{{ route('client.update',$user->id) }}" method="PUT" id="Clientform">
                            ...
                            <div class="card-header">
                                <ul class="nav nav-tabs " id="myTab" role="tablist">
                                    <li class="nav-item">
                                      <a class="nav-link  active" id="Information-tab" data-toggle="tab" href="#Information" role="tab" aria-controls="Information" aria-selected="true">Client Information</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="Details-tab" data-toggle="tab" href="#Details" role="tab" aria-controls="Details" aria-selected="true">Account Details</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="Credits-tab" data-toggle="tab" href="#Credits" role="tab" aria-controls="Credits" aria-selected="false">Account Credits
                                        </a>
                                    </li>
                                    <li class="nav-item">
