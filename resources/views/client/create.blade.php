                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs " id="myTab" role="tablist">
                                    <li class="nav-item">
                                    <a class="nav-link  active" id="account-details" data-toggle="tab" href="#account" role="tab" aria-controls="account-details" aria-selected="true">Account Details</a>
                                    </li>
                                    <li class="nav-item">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select form-control bill_cycle_create_text" name="billing_cycle"
                                                            id="billing_cycle">
...
{{-- <script type="text/javascript">
    ...
    $('.create').click(function (e){
        e.preventDefault();
        $('.next_invoice_date').addClass('hidden');
        $('#next_invoice_date').removeClass('hidden');
        $('.create').addClass('d-none');
    })
    $('.create_bill_cycle').click(function (e){
        e.preventDefault();
        $('.bill_cycle_create_text').addClass('hidden');
        $('#billing_cycle').removeClass('hidden');
        $('.create_bill_cycle').addClass('d-none');
        $('.next_invoice_date').addClass('hidden');
        $('#next_invoice_date').removeClass('hidden');
        $('.create').addClass('d-none');
    })
