                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control" name="protocol" id="parent">
                                        <option value="FTP - File Transfer Protocol">FTP - File Transfer Protocol</option>
                                        <option value="SFTP - SSH File Transfer Protocol">SFTP - SSH File Transfer Protocol</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="csv_path" name="csv_path" value="">
                                </div>
                                <div class="form-group">
