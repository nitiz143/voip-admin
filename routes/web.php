...
Route::group(['middleware' => ['auth','activity']], function () {
    ...
    Route::get('/cdr-show', [App\Http\Controllers\CallController::class, 'index'])->name('cdr_show.index');
    ...
    //rebuild
    Route::any('/csv_view_rebuild','App\Http\Controllers\CallController@csv_view_rebuild')->name('csv.view.rebuild');
    ...
    Route::get('/export-history/xlsx','App\Http\Controllers\CallController@export_history_xlsx');
    ...
    Route::get('/vendor_preference-edit/{id}', [App\Http\Controllers\ClientController::class, 'vendor_preference_edit'])->name('vendor_preference.edit');
